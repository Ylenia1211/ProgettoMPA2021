...
public class ConcreteObserver implements Observer {
    ...
    @Override
    public void update() {
        //il concrete observer diventa il client, responsabile della creazione della catena di handler che gestiscono l'invio dell'email
        //process(this, businessHandler, gMailHandler);  //il send dell'email lo gestisce
        //old
